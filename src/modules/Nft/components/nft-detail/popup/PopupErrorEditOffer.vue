<template>
  <base-popup name="popup-error-cancel-bid" class="popup-error-cancel-bid" width="400px" :open="handleCommand" :close="handleClose">
    <div slot="title" class="header-popup">
      <p>{{ $t('detail-nft.popup-bid-success.header-fail') }}</p>
    </div>
    <div class="content">
      <img src="../../../../../assets/images/nft/fail.png" alt="" />
      <div class="title-succes text-base color-primary text-semibold">{{ $t('edit-bid-offer.title-edit-fail') }}</div>
