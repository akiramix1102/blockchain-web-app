    ...
    <div class="contract-container" v-if="showContract">
      <div class="sack-coin">
        ...
        <div class="title" @click="handleOpenTabUniswap">
          ...
          <p class="is-pc">LBank:</p>
          <span class="is-pc" style="margin-left: 6px"> https://www.lbank.info/exchange/lynk/usdt/#usd </span>
          <span class="is-mobile" style="margin-left: 3px">https://www.lbank.info/exchange/lynk/usdt</span>
        </div>
      </div>
    ...
    <div class="menu-container">
      <div class="menu-logo">
        <a class="navbar-brand" href="#">
          <img src="../../../assets/images/landing/logo.png" alt="Logo" class="style-logo style-logo--scroll" />
        </a>
      </div>
      ...
      <ul class="sack-item" :class="{ 'sack-item-no-contract': !showContract }">
        ...
        <li class="menu-item li-item" @click="handleClick('roadmap')">
          <div class="menu-link">
            {{ $t('landing-ido.menu-roadmap') }}
            <i class="sack-menu-effect"></i>
          </div>
        </li>
        <li class="menu-item li-item" @click="handleClick('docs')">
          <div class="menu-link">
            {{ $t('landing-ido.menu-docs') }}
            <i class="sack-menu-effect"></i>
          </div>
        </li>
  ...
  export default {
    ...
    methods: {
      ...
      handleOpenTabUniswap() {
        window.open(`https://www.lbank.info/exchange/lynk/usdt/#usd`, '_blank')
      }
    },
    computed: {
    ...
    mounted() {
      ...
      menuLink.forEach(element => {
        element.addEventListener('click', function () {
          if (window.innerWidth < 1023) {
            sackItem.classList.toggle('active')
        ...
        document.addEventListener('click', function (e) {
          if (!sackItem.contains(e.target) && !menuMobile.contains(e.target)) {
            sackItem.classList.remove('active')
