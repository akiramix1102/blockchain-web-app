<template>
  <div class="kyc-content-mobile">
    <div v-if="statusKyc === 'REJECTED'">
      ...
      <div class="personal-verifi mt48">
            ...
            <div style="position: relative">
              ...
              >
                <div v-if="!idPhoto1">
                  ...
                  <div class="el-upload__text">
                    <em>{{ $t('settingkyc.clickupload') }}</em>
                  </div>
                </div>
              ...
              <div v-if="idPhoto1" class="be-flex nav-image" style="justify-content: center">
                <div class="rotate" @click="rotateRightImage(0)">
                  <base-icon icon="icon-rotate1" style="color: #5b616e; margin-right: 4px" size="18" class="icon" />
                  Rotate
                </div>
        ...
        <div>
          <div class="personal-verifi-id-photo">{{ $t('settingkyc.noteselfie') }}<span class="error1">*</span></div>
          <div class="personal-verifi-id-photo-description">
          ...
          <div class="personal-verifi-back-side-selfie">
            ...
            <div v-if="dataInput.idcard === 'DRIVER_LICENSE'">
              ...
              <img v-else class="img-style" src="../../../../icons/png/Driver'slicense-selfie-clm.png" alt="" />
            </div>
            <div style="position: relative">
              <el-upload
                class="upload-demo"
    ...
    <!-- phan insert -->
    <div class="personal-verifi" v-if="statusKyc === 'NONE'">
      <div class="personal-verifi-hedding">{{ $t('settingkyc.headding1') }}</div>
      <div class="personal-verifi-about-form">
        <el-form status-icon :model="dataInput" :rules="rules" class="personal-verifi-form">
          <div class="el-row" :gutter="10">
      ...
      <div>
        ...
        <div class="personal-verifi-front-side">
          <div style="position: relative" class="front-side-upload">
            <el-upload
              class="upload-demo"
              drag
              :file-list="fileList"
            ...
            >
              <!-- <i class="el-icon-upload"></i> -->
              <div v-if="!idPhoto1" class="wrapper-text-upload" style="display: flex; flex-direction: column; justify-content: center">
                <span class="style-headding-side" v-if="dataInput.idcard === 'ID_CARD' || dataInput.idcard === 'DRIVER_LICENSE'">{{ $t('settingkyc.frontSide') }}</span>
                <span class="style-headding-side" v-if="dataInput.idcard === 'PASSPORT'">{{ $t('settingkyc.passportCover') }}</span>
                <base-icon icon="icon-upload" size="30" />
                <div class="el-upload__text">
                  <em>{{ $t('settingkyc.clickupload') }}</em>
                </div>
              </div>
              <img v-if="dataInput.idcard === 'ID_CARD'" class="img-style" src="../../../../icons/png/imgIdCard.png" alt="" />
              <img v-if="dataInput.idcard === 'PASSPORT'" class="img-style" src="../../../../icons/png/imgPassport.png" alt="" />
              <img v-if="dataInput.idcard === 'DRIVER_LICENSE'" class="img-style" src="../../../../icons/png/Driver-license-front.png" alt="" />
        ...
        <div class="personal-verifi-back-side">
          <div style="position: relative">
            <el-upload class="upload-demo" drag :file-list="fileList2" :on-change="handleChangeFile2" :auto-upload="false" :show-file-list="false" action style>
              <!-- <i class="el-icon-upload"></i> -->
              <div v-if="!idphoto2" class="wrapper-text-upload" style="display: flex; flex-direction: column; justify-content: center">
                <span class="style-headding-side" v-if="dataInput.idcard === 'ID_CARD' || dataInput.idcard === 'DRIVER_LICENSE'">{{ $t('settingkyc.backSide') }}</span>
                <span class="style-headding-side" v-if="dataInput.idcard === 'PASSPORT'">{{ $t('settingkyc.passportpage') }}</span>
                <base-icon icon="icon-upload" size="30" />
                <div class="el-upload__text">
      ...
      <div>
        ...
        <div class="personal-verifi-back-side-selfie">
          ...
          <div v-if="dataInput.idcard === 'DRIVER_LICENSE'">
            <img v-if="coinMain === 'LYNK'" class="img-style" src="../../../../icons/png/Driver's-license-selfie.png" alt="" />
            <img v-else class="img-style" src="../../../../icons/png/Driver'slicense-selfie-clm.png" alt="" />
          </div>

          <div style="position: relative">
            <el-upload class="upload-demo" drag :file-list="fileList3" :on-change="handleChangeFile3" :auto-upload="false" :show-file-list="false" action style="margin-top: 16px">
              <div v-if="!selfiePhoto" class="el-upload__text" style="display: flex; flex-direction: column; justify-content: center; margin-top: 50px">
                <div style="margin-bottom: 19px; font-size: 16px; font-weight: 600; color: #0a0b0d">{{ $t('settingkyc.selfie-upload-text') }}</div>
                <base-icon icon="icon-upload" size="30" />
                <em>{{ $t('settingkyc.clickupload') }}</em>
              </div>
    ...
    <div class="kyc-success" v-if="statusKyc === 'VERIFIED'">
      <div class="kyc-success-top" :class="coinMain === 'CLM' ? 'kyc-success-top--clm' : null">
        <base-icon v-if="coinMain === 'LYNK'" icon="icon-notification-success" class="icon-success1" size="20"></base-icon>
        <base-icon v-else icon="icon-notification-success-clm" class="icon-success1" size="20"></base-icon>
      ...
      <div class="kyc-success-bottom">
        <base-icon v-if="coinMain === 'LYNK'" icon="iconcSuccess" class="icon-success" size="60"></base-icon>
        <base-icon v-else icon="iconcSuccess-clm" class="icon-success" size="60"></base-icon>
    ...
    <div class="kyc-pendding" v-if="statusKyc === 'PENDING'">
      <base-icon icon="progressing" class="icon-pendding" size="60"></base-icon>
      <div class="information-right">
...
<script lang="ts">
  ...
  export default class MobileKyc extends Vue {
...
<style scoped lang="scss">
  .kyc-content-mobile {
    ...
    .personal-verifi-form {
      ...
      ::v-deep.el-form-item .type--verifi {
        .el-radio-group {
          display: inline-flex;
          flex-direction: column;
          .el-radio {
    ...
    .personal-verifi-back-side-selfie {
      display: flex;
      align-items: center;
      justify-content: flex-start;
      flex-direction: column;
