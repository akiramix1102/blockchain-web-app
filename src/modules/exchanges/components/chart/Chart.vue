<template>
  <div class="container">
    ...
    <div class="chart">
      <div class="info">
        <base-icon icon="trade-arrow-down" class="icon-trade" @click.native="visiblePrice = !visiblePrice" v-show="visiblePrice"></base-icon>
        <base-icon icon="trade-arrow-right" class="icon-trade" @click.native="visiblePrice = !visiblePrice" v-show="!visiblePrice"></base-icon>
        <span v-if="visiblePrice">
      ...
      <div class="info-volume" v-if="!deleteVolume">
        <base-icon icon="trade-arrow-down" class="icon-trade" @click.native="visibleVolume = !visibleVolume" v-show="visibleVolume"></base-icon>
        <base-icon icon="trade-arrow-right" class="icon-trade" @click.native="visibleVolume = !visibleVolume" v-show="!visibleVolume"></base-icon>
        ...
        <base-icon icon="trade-eye" class="icon-trade" @click.native="hideVolume" v-show="visibleShow && visibleVolume"></base-icon>
        <base-icon icon="trade-hide-eye" class="icon-trade" @click.native="showVolume" v-show="!visibleShow && visibleVolume"></base-icon>
        <base-icon icon="trade-delete" class="icon-trade trade-delete" v-if="!closeVolume && visibleVolume" @click.native="removeVolume"></base-icon>
      </div>
    </div>
  </div>
</template>
