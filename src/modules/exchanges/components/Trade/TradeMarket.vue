  ...
  <div class="trade">
    <div class="content">
      <div class="trade-lynk">
        ...
        <base-input :textPrefix="'Price'" :textSuffix="'Market &nbsp; USDT'" :isReadOnly="true" class="price-market" v-model="priceBuy"></base-input>
        <base-input
          :textSuffix="typeBuy === 'Amount' ? 'LYNK' : 'USDT'"
          :isShowSelect="true"
          @select="handleSelectInput"
          v-model="amountBuy"
          @type="handleChangeTypeBuy"
        ></base-input>
        ...
        <div class="btn-confirm">
          ...
          <button class="text-confirm text-base text-bold btn-buy cursor" v-else>Buy LYNK</button>
        </div>
      </div>
      <div class="trade-lynk">
        <div class="text-regular text-xs jc-space-between be-flex label">
        ...
        <base-input :textPrefix="'Price'" :textSuffix="'Market &nbsp; USDT'" :isReadOnly="true" class="price-market" v-model="priceSell"></base-input>
        <base-input
          :textSuffix="typeSell === 'Amount' ? 'LYNK' : 'USDT'"
          :isShowSelect="true"
          @select="handleSelectInput"
          v-model="amountSell"
          @type="handleChangeTypeSell"
        ></base-input>
        <div class="jc-space-between mb-16 tab-amount">
          <div
            class="text-base cursor amount-item"
...
<script lang="ts">
  ...
  export default class TradeMarket extends Vue {
    ...
    handleChangeTypeBuy(selectStep: string): void {
      this.typeBuy = selectStep
    }
    handleChangeTypeSell(selectStep: string): void {
      this.typeSell = selectStep
    }
  }
</script>
