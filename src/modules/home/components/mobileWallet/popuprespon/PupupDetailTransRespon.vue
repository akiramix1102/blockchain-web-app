<template>
  <base-popup name="popup-detail-trans-respon" class="popup-detail-trans" width="335px" :isShowFooter="false">
    <div slot="title">
    ...
    <div class="content">
      ...
      <div class="content__main">
        ...
        <div v-if="includeTypeStaking" class="be-flex jc-space-between align-center row-item">
          <span class="title text-body-small">Package</span>
          <span class="text-base text-regular color-primary">
            {{ rowCurrent.itemName }}
          </span>
        </div>
        <!-- end -->
...
<script lang="ts">
  ...
  export default class PopupDetailTransRespon extends Mixins(PopupMixin) {
    ...
    get isIncludeTypeNFT(): boolean {
      const otherType: string[] = ['ROYALTIES_FEE', 'NFT_TRANSFER', 'NFT_SALE']
      return includes(otherType, this.rowCurrent.transactionType)
    }
    get getIcon(): string {
